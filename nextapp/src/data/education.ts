...
export const diseases: KidneyDisease[] = [
  {
    ...
    slug: "ckd",
    image: "/images/conditions/ckd.jpg",
    shortDescription: "A long-term condition where the kidneys don't work as well as they should. It gradually worsens over time.",
    ...
    medicalCare: "If you experience persistent swelling, extreme fatigue, or changes in urination patterns, consult a doctor immediately."
  },
  {
    title: "Acute Kidney Injury (AKI)",
    slug: "aki",
    image: "/images/conditions/aki.jpg",
    shortDescription: "Sudden damage to the kidneys that causes them to stop working properly. It can range from minor loss of function to complete failure.",
    ...
    medicalCare: "AKI is a medical emergency. Seek immediate care if you stop urinating or experience severe confusion/shortness of breath."
  },
  {
    title: "Kidney Stones",
    slug: "kidney-stones",
    ...
    medicalCare: "Seek immediate attention if pain is so severe you can't sit still, accompanied by nausea, vomiting, fever, or chills."
  },
  {
    title: "Urinary Tract Infection (UTI)",
    slug: "uti",
    image: "/images/conditions/uti.jpg",
    shortDescription: "An infection in any part of the urinary system, the kidneys, bladder or urethra.",
    ...
    medicalCare: "Contact a healthcare provider if symptoms persist for more than a day or if you develop back pain and fever, which may indicate a kidney infection."
  },
  {
    title: "Polycystic Kidney Disease (PKD)",
    slug: "pkd",
    image: "/images/conditions/pkd.jpg",
    shortDescription: "An inherited disorder in which clusters of cysts develop primarily within your kidneys, causing your kidneys to enlarge and lose function over time.",
    ...
    medicalCare: "If you have a family history of PKD or develop unexplained flank pain and high blood pressure, consult a nephrologist."
  },
  {
    title: "Glomerulonephritis",
    slug: "glomerulonephritis",
    image: "/images/conditions/glomerulonephritis.jpg",
    shortDescription: "Inflammation of the tiny filters in your kidneys (glomeruli) that remove excess fluid, electrolytes and waste from your bloodstream.",
    ...
    medicalCare: "See a doctor immediately if you notice blood in your urine or sudden, severe swelling in your face or limbs."
  },
  {
    title: "Diabetic Kidney Disease",
    slug: "diabetic-kidney-disease",
    image: "/images/conditions/diabetic-kidney-disease.jpg",
    shortDescription: "A serious complication of type 1 and type 2 diabetes affecting the kidneys' ability to do their usual work of removing waste products.",
    ...
    medicalCare: "Diabetics should have their urine and blood checked annually. See a doctor if you notice new swelling or extreme fatigue."
  },
  {
    title: "Hypertensive Kidney Disease",
    slug: "hypertensive-kidney-disease",
    image: "/images/conditions/hypertensive-kidney-disease.jpg",
    shortDescription: "Kidney damage caused by chronic high blood pressure, which damages blood vessels in the kidneys.",
    ...
    medicalCare: "Regular screening is crucial if you have hypertension. Seek care if your blood pressure readings are consistently high."
  }
];
